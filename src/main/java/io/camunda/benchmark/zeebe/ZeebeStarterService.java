...
public class ZeebeStarterService {
	...
	public void buildZeebe() throws IOException, InterruptedException {
		...
		ProcessUtils.execBlocking("helm install --namespace "+kubeConfig.namespace+" "+kubeConfig.namespace+"-dtcc camunda-cloud/ccsm-helm -f target/zeebe-values.yaml --skip-crds");
	}
