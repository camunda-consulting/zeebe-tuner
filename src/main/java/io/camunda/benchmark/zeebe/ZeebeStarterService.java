...
public class ZeebeStarterService {
	...
	public void buildZeebe() throws IOException, InterruptedException {
		...
		ProcessUtils.execBlocking("helm install --namespace "+kubeConfig.kubePrefix+" "+kubeConfig.kubePrefix+"-dtcc camunda-cloud/ccsm-helm -f target/zeebe-values.yaml --skip-crds");
	}
	...
	public void exposeZeebe() throws IOException, InterruptedException {
		ProcessUtils.execBlocking("kubectl port-forward svc/"+kubeConfig.kubePrefix+"-dtcc-zeebe-gateway 26500:26500 -n "+kubeConfig.kubePrefix);
	}
