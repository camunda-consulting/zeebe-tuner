...
public class ZeebeStarterService {
	...
	public void buildZeebe() throws IOException, InterruptedException {
		...
		ProcessUtils.execBlocking("helm install --namespace "+kubeConfig.namespace+" "+kubeConfig.namespace+"-dtcc camunda-cloud/ccsm-helm -f testruns/zeebe-values.yaml --skip-crds");
	}
	...
	public void exposeZeebe() throws IOException, InterruptedException {
		ProcessUtils.execBlocking("kubectl port-forward svc/"+kubeConfig.namespace+"-dtcc-zeebe-gateway 26500:26500 -n "+kubeConfig.namespace);
	}
